...
public class Rocl implements Tropa, Serializable {
	...
	int golpePrim = 185;
	int golpeSec = 0;
	ListaArmas armaPrincipal = ListaArmas.COHETE;
	...
	public String toString() {
		return "Rocl [idTropa=" + idTropa + ",team" + team + ", tipoTropa=" + tipoTropa + ", tipoMov=" + tipoMov + ", captura=" + captura
