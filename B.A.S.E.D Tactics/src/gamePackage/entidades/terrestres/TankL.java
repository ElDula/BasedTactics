...
public class TankL implements Tropa, Serializable {
	...
	public String toString() {
		return "TankL [idTropa=" + idTropa + ", tipoTropa=" + tipoTropa + ", tipoMov=" + tipoMov + ", captura="
