...
public class Factory implements Estructura, Serializable{
		
	private static final long serialVersionUID = 6540278697343146269L;
		...
		try {
			if(suministra(trop) == true) {
				...
				if(trop.getSalud() <= trop.getSaludMax()){
					trop.setSalud((int)(trop.getSalud() + 1));
				}
			}}
